...
public class BookingsController : ControllerBase
{
    ...
    [HttpPut("response")]
    [Authorize]
    public async Task<IActionResult> ResponseRequest(string id, BookingEnums.StatusBooking status)
    {
    ...
    [Authorize]
    public async Task<IActionResult> ResponseDetail(string id, BookingEnums.StatusBookingDetail status, string? rejectionReason)
    {
